...
config_args = {
    'training_config': {
        ...
        'save_log': (0, '1 to save model and logs and 0 otherwise'),
    ...
    'model_config': {
        ...
        'dim': (128, 'embedding dimension, {8, 32, 128}'),
        ...
        'hyp_ireg': ('0', '0: no regularization, options: hir_tangent, hire_tangent, hir_manifold, hire_manifold'),
        'ireg_lambda': (0.0, 'regularization strength'),
        'save_acc_roc': (0, 'whether to save acc_roc or not'),
        'save_hdo_value': (0, 'whether to save hdo value or not'),
    },
    'data_config': {
        ...
        'runs': (1, 'run times'),
        'draw_dist_curv': (0, 'draw dist curv or not'),
        'draw_embedding': (0, 'draw embeddings or not'),
        'data_root': ('./data', 'draw embeddings or not'),
        'centrality': ('hc', 'centers. [hc, cc, dc, bc, ec]'),
        'center': (0, 'centers.'),
    }
}
